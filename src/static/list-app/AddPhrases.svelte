...
<section>
	...
	<small>
		<Icon icon="info" />
		Hint: If you're using the Context.Reviews browser extension (install links can be found on the Help dialog) your Jisho
		searches will automatically appear here, but you can always use this to add phrases by hand or in bulk.
	</small>
</section>
