...
<div class="panel-body f-column">
	<p>
		Your browser's built-in speech synthesis can be used to read words, as hearing can make it easier to remember. It's
		not always accurate so make sure to reference the word's reading.
	</p>
