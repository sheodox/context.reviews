...
<div class="container has-inline-links">
		...
		<ol>
			<li>
				...
				<p class="hint">
					...
					When you are reading a web page you can select some Japanese text then click that bookmark to quickly open a
					Jisho search!
				</p>
			</li>
			<li>
	...
	<Tab tabId="help-list" {selectedTab}>
		<h2>Usage</h2>
		<p>
			The phrase list is the first page you land on when you log in. From here you can view and manage all of your saved
			phrases. If you highlight some text in a phrase the Jisho definition search results will automatically show up in
	...
	<Tab tabId="help-export" {selectedTab}>
		...
		<p>
			...
			you want to study and choose the definition that's most applicable from the definitions that show then click "Add
			Card".
		</p>

		<p>
			The primary spelling from the Jisho result is used automatically used, but if you prefer an alternate spelling you
			can click on one of the alternates shown below the definition or you can manually type whatever spelling and
			reading you want.
		</p>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td
						>Parts of words that match your search term will be highlighted, you will often see this when you searching
						a conjugated form.</td
					>
				</tr>
				<tr>
					<td>まったく</td>
