...
<div on:mouseenter={pauseExpiration} on:mouseleave={resumeExpiration}>
	{#if $hasHiddenToasts}
	...
	{#each $toasts as toast}
		<StasherToast {toast} {toastAnimations} />
	{/each}
...
<script>
	...
	import { toasts, hasHiddenToasts, pauseExpiration, resumeExpiration, replayToasts } from './toast-stores';
